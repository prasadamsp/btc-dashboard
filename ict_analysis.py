# =============================================================================
# Bitcoin Weekly Bias Dashboard — ICT Analysis Engine
# =============================================================================
"""
Applies Inner Circle Trader (ICT) concepts algorithmically to Bitcoin price data
...
def _build_rationale(direction: str,
    ...
    if current_price is not None and fifty_pct is not None:
        ...
        parts.append(
            f"Bitcoin at ${current_price:,.0f} is in a {zone} zone "
            f"(50% fib = ${fifty_pct:,.0f})."
        )
...
def generate_ict_trades(monthly_df: pd.DataFrame,
    ...
    """
    Generate 3 daily ICT trade setups for Bitcoin.
